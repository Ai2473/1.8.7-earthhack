...
public class Colors extends Module
{
    ...
    public Setting<Color> modulesColorsetting =
            register(new ColorSetting("ModulesColor", new Color(0, 80, 255, 255))); // working
    public Setting<Color> moduleHoversetting =
            register(new ColorSetting("ModuleHover", new Color(0, 80, 255, 255))); // working
    public Setting<Color> settingColorsetting =
            register(new ColorSetting("SettingColor", new Color(224, 224, 224, 255))); // working
    public Setting<Color> onModulesetting =
            register(new ColorSetting("EnabledText", new Color(0, 80, 255, 255))); // working
    public Setting<Color> offModulesetting =
            register(new ColorSetting("DisabledText", new Color(0, 80, 255, 255))); // working
    public Setting<Color> topColorsetting =
            register(new ColorSetting("SectionColorSide", new Color(0, 80, 255, 255))); // working
